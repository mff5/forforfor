...
<%
    ...
    ArrayList<Product> productList = dao.productListEtc(sortBy);
...
<main>
    <section>
        ...
        <div style="text-align: right">
            <a href="${pageContext.request.contextPath}/views/etc.jsp?sortBy=sales">판매량순</a> |
            <a href="${pageContext.request.contextPath}/views/etc.jsp?sortBy=discount">할인율순</a> |
            <a href="${pageContext.request.contextPath}/views/etc.jsp?sortBy=priceAsc">낮은가격순</a> |
